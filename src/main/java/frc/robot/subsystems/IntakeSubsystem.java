...
public class IntakeSubsystem extends SubsystemBase {
  ...
  CANSparkMax leftMotor = new CANSparkMax(MotorConstants.leftIntakeMotorID, MotorType.kBrushless);
  CANSparkMax rightMotor = new CANSparkMax(MotorConstants.rightIntakeMotorID, MotorType.kBrushless);
