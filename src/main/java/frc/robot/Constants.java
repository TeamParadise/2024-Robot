...
public final class Constants {
  ...
  public static class VisionConstants {
    ...
    public static final Transform3d kRobotToLeftCam =
        new Transform3d(new Translation3d(Units.inchesToMeters(18.375), Units.inchesToMeters(15+2.75), Units.inchesToMeters(7.34)), new Rotation3d(Units.degreesToRadians(180), Units.degreesToRadians(-46.5), 0));
  ...
  public static class SpeedConstants {
    ...
    public static final double kShooter = 5000;
